...
public class InventoryListActivity extends RoboActivity {
	...
	@InjectView(R.id.commodityList) private ListView commoditiesView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		commodities = PersonModel.getPersonInstance().getInventaryList().get(0).getInventoryCommodities();
